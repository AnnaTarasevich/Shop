...
Процедура КомандаОткрыть(Команда)
	...
	ДиалогВыбораФайла.Фильтр    = "Табличный документ (*.mxl)|*.mxl|Лист Excel (*.xls)|*.xls|Текстовый документ (*.txt)|*.txt|dBase III (*.dbf)|*.dbf|Книга Excel (*.xlsx)|*.xlsx|CSV UTF-8 (разделитель запятая) (*.csv)|*.csv";
