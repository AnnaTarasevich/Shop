...
Процедура ВыгрузитьВXML(Команда)
    #Если МобильноеПриложениеКлиент Тогда
        ...
        Попытка
            ...
            // Попытка сохранить в стандартную папку Download
            Попытка
            ...
            Исключение
                // Альтернативный способ через системный диалог
                Попытка
...
Процедура ЗаписатьАтрибутыЭлемента(ЗаписьXML, Выборка, ИмяСправочника)
    // Преобразовать все значения к строковому типу перед записью
